...
function renderRail(){
  ...
  <aside class="rail">
    ...
    <div class="rail__foot">
      <strong>ذخیره‌سازی محلی:</strong> همه‌چیز فقط توی همین مرورگر می‌مونه، هیچ اطلاعاتی جایی ارسال نمیشه. اگه یه روز حافظه یا اطلاعات مرورگر (Chrome) رو پاک کنی، همه‌ی حساب‌هایی که اینجا ذخیره کردی هم برای همیشه از بین میره — پس هر از گاهی از بخش PDF یه نسخه پشتیبان بگیر.
    </div>
  </aside>`;
}
